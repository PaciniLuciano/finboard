...
FII_SEGMENTO_MANUAL = {
    "KNCR": "FII_PAPEL",   "KNIP": "FII_PAPEL",   "MXRF": "FII_PAPEL",
    "CPTS": "FII_PAPEL",   "HCTR": "FII_PAPEL",   "IRDM": "FII_PAPEL",
    "VGIR": "FII_PAPEL",   "RBRR": "FII_PAPEL",   "BBPO": "FII_PAPEL",
    "HGLG": "FII_TIJOLO_LOGISTICA", "BTLG": "FII_TIJOLO_LOGISTICA",
    "VILG": "FII_TIJOLO_LOGISTICA", "XPLG": "FII_TIJOLO_LOGISTICA",
    "LVBI": "FII_TIJOLO_LOGISTICA", "GZIT": "FII_TIJOLO_LOGISTICA",
    "BRCO": "FII_TIJOLO_LAJES",    "BRCR": "FII_TIJOLO_LAJES",
    "PVBI": "FII_TIJOLO_LAJES",    "RBRP": "FII_TIJOLO_LAJES",
    "HGRE": "FII_TIJOLO_LAJES",    "JSRE": "FII_TIJOLO_LAJES",
    "HGBS": "FII_TIJOLO_SHOPPING", "XPML": "FII_TIJOLO_SHOPPING",
    "VISC": "FII_TIJOLO_SHOPPING", "MALL": "FII_TIJOLO_SHOPPING",
    "HFOF": "FII_HIBRIDO", "BCFF": "FII_HIBRIDO",
    "RBRF": "FII_HIBRIDO", "KFOF": "FII_HIBRIDO",
    "RURA": "FII_AGRO",    "BTRA": "FII_AGRO",
}
...
async def enriquecer_e_salvar(ticker: str, classe: str):
    ...
    try:
        ...
        from backend.database import get_db, AtivoMaster
        db = next(get_db())
        try:
